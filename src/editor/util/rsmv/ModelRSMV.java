...
public final class ModelRSMV extends class18 {
   ...
   public static ModelRSMV createEmptyModel() {
      return properties == null ? null : new ModelRSMV(0);
   }

   public static ModelRSMV loadModel(byte[] modelBytes) {
      return new ModelRSMV(modelBytes);
   }
